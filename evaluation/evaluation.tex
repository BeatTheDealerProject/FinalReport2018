...
次に、それぞれの結果を図\ref{evaluation-gizyutu}、図\ref{evaluation-naiyou}、図\ref{evaluation-rule}、図\ref{evaluation-kensyou}に示す。
...
\begin{figure}[h]
 \begin{tabular}{cc}
  \begin{minipage}[h]{0.45\hsize}
  \centering
 \includegraphics[width=0.7\linewidth]{./figure/evaluation-rule.jpg}
\caption{ルール説明の評価グラフ}
...
\begin{minipage}[h]{0.45\hsize}
  \centering
 \includegraphics[width=0.7\linewidth]{./figure/evaluation-kensyou.jpg}
 \caption{検証説明の評価グラフ}
